...
class TestCompleteQueryPipeline(unittest.TestCase):
    ...
    def test_content_query_full_pipeline(self, mock_session_manager, mock_ai_generator, mock_vector_store, mock_doc_processor):
        ...
        # Mock AI response
        mock_ai_instance.generate_response.return_value = "Cross-encoder re-ranking is a technique..."
